<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Calendario.aspx.cs" Inherits="ConservatorioVANew.Calendario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="menuLateralIzquierdo" runat="server">
    <ul class="menu-nav">
        ...
        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
            <a href="Calendario.aspx" class="menu-link menu-toggle" style="background-color:#F64E60">
                <span class="svg-icon menu-icon">
                ...
                <span class="menu-text" style="color: white">Calendario</span>
            </a>
        </li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="navPrincipal" runat="server">
    <ul class="dashboard-tabs nav nav-pills nav-danger row row-paddingless m-0 p-0 flex-column flex-sm-row" role="tablist">
        ...
        <li class="nav-item d-flex col-sm flex-grow-1 flex-shrink-0 mr-0 mb-3 mb-lg-0">
            <a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center" href="Calendario.aspx" style="background-color: #F64E60">
                <span class="nav-icon py-2 w-auto">
                    <span class="svg-icon svg-icon-3x">
                ...
                <span class="nav-text font-size-lg py-2 font-weight-bolder text-center" style="color: white">Calendario</span>
            </a>
        </li>
        <!--end::Item-->
    </ul>
