<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Alumnos.aspx.cs" Inherits="ConservatorioVANew.Alumnos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="menuLateralIzquierdo" runat="server">
    <ul class="menu-nav">
        ...
        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
            <a href="Alumnos.aspx" class="menu-link menu-toggle" style="background-color:#F64E60">
                <span class="svg-icon menu-icon">
                ...
                <span class="menu-text" style="color: white">Alumnos</span>
            </a>
        </li>
        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
...
<asp:Content ID="Content3" ContentPlaceHolderID="navPrincipal" runat="server">
    <ul class="dashboard-tabs nav nav-pills nav-danger row row-paddingless m-0 p-0 flex-column flex-sm-row" role="tablist">
        ...
        <!--begin::Item-->
        <li class="nav-item d-flex col-sm flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
            <a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center" href="Alumnos.aspx" style="background-color: #F64E60">
                <span class="nav-icon py-2 w-auto">
                    <span class="svg-icon svg-icon-3x">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
                ...
                <span class="nav-text font-size-lg py-2 font-weight-bolder text-center" style="color: white">Alumnos</span>
            </a>
        </li>
        <!--end::Item-->
        <!--begin::Item-->
